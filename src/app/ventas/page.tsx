                ...
                <div className="flex-1 p-6">
                    {cashStatus.isOpen ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full">
                            {autoCloseWarning && (
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6 max-w-md flex items-start gap-3">
                                    <AlertTriangle className="h-5 w-5 text-yellow-600 flex-shrink-0 mt-0.5" />
                                    <div>
                                        <p className="text-sm font-medium text-yellow-800">Caja anterior cerrada automáticamente</p>
                                        <p className="text-sm text-yellow-700 mt-1">{autoCloseWarning}</p>
                                    </div>
                                    <button onClick={() => setAutoCloseWarning(null)} className="text-yellow-600 hover:text-yellow-800 text-lg leading-none">×</button>
                                </div>
                            )}
